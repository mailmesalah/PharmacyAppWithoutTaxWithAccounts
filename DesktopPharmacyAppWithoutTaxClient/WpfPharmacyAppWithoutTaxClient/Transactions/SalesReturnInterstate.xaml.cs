...
namespace WpfClientApp.Transactions
{
    ...
    /// </summary>
    public partial class SalesReturnInterstate : Window
    {
        ...
        public SalesReturnInterstate(string billNo, DateTime billDate)
        {
            InitializeComponent();
            loadInitialDetails();
        ...
        private string getLastBillNo()
        {
            ...
            try {
                using (ChannelFactory<ISalesReturn> SalesReturnProxy = new ChannelFactory<ServerServiceInterface.ISalesReturn>("SalesReturnEndpoint"))
                {
                    ...
                    billNo=SalesService.ReadNextBillNo("SRI",CommonMethods.getFinancialCode(mDTPDate.SelectedDate.Value)).ToString();                    
                }
            }
            catch (Exception e)
            {
        ...
        private void showDataFromDatabase()
        {
            try
            {
                using (ChannelFactory<ISalesReturn> SalesReturnProxy = new ChannelFactory<ServerServiceInterface.ISalesReturn>("SalesReturnEndpoint"))
                {
                    ...
                    CSalesReturn ccr= SalesReturnervice.ReadBill(mTextBoxBillNo.Text.Trim(), "SRI", CommonMethods.getFinancialCode(mDTPDate.SelectedDate.Value));
        ...
        private void showRefBillDataFromDatabase()
        {
            try
            {
                using (ChannelFactory<ISalesReturn> SalesProxy = new ChannelFactory<ServerServiceInterface.ISalesReturn>("SalesReturnEndpoint"))
                {
                    ...
                    CSalesReturn ccr = SalesService.ReadSalesBill(mTextBoxRefBillNo.Text.Trim(), "SI", CommonMethods.getFinancialCode(mDTPRefDate.SelectedDate.Value));
        ...
        private void saveDataToDatabase()
        {
            ...
            {                
                ...
                using (ChannelFactory<ISalesReturn> SalesReturnProxy = new ChannelFactory<ServerServiceInterface.ISalesReturn>("SalesReturnEndpoint"))
                {
                    ...
                    if (mSalesReturnID != "")
                    { 
                        success = SalesReturnService.UpdateBill(ccp, "SRI");
                    }
                    else
                    {                    
                        success = SalesReturnService.CreateBill(ccp, "SRI");
                    }
        ...
        private void deleteDataFromDatabase()
        {
            try
            {
                using (ChannelFactory<ISalesReturn> SalesReturnProxy = new ChannelFactory<ServerServiceInterface.ISalesReturn>("SalesReturnEndpoint"))
                {
                    ...
                    bool success= PurchaService.DeleteBill(mTextBoxBillNo.Text.Trim(), "SRI", CommonMethods.getFinancialCode(mDTPDate.SelectedDate.Value));
