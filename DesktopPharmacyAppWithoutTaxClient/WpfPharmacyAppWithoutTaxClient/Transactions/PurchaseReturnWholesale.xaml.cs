...
namespace WpfClientApp.Transactions
{
    ...
    /// </summary>
    public partial class PurchaseReturnWholesale : Window
    {
        ...
        public PurchaseReturnWholesale(string billNo, DateTime billDate)
        {
            InitializeComponent();
            loadInitialDetails();
        ...
        public PurchaseReturnWholesale()
        {
            InitializeComponent();
            loadInitialDetails();
        ...
        private string getLastBillNo()
        {
            ...
            try {
                using (ChannelFactory<IPurchaseReturn> PurchaseReturnProxy = new ChannelFactory<ServerServiceInterface.IPurchaseReturn>("PurchaseReturnEndpoint"))
                {
                    ...
                    billNo=PurchaseService.ReadNextBillNo("PRW",CommonMethods.getFinancialCode(mDTPDate.SelectedDate.Value)).ToString();                    
                }
            }
            catch (Exception e)
            {
        ...
        private void showDataFromDatabase()
        {
            try
            {
                using (ChannelFactory<IPurchaseReturn> PurchaseReturnProxy = new ChannelFactory<ServerServiceInterface.IPurchaseReturn>("PurchaseReturnEndpoint"))
                {
                    ...
                    CPurchaseReturn ccr= PurchaseReturnervice.ReadBill(mTextBoxBillNo.Text.Trim(), "PRW", CommonMethods.getFinancialCode(mDTPDate.SelectedDate.Value));
        ...
        private void showRefBillDataFromDatabase()
        {
            try
            {
                using (ChannelFactory<IPurchaseReturn> PurchaseProxy = new ChannelFactory<ServerServiceInterface.IPurchaseReturn>("PurchaseReturnEndpoint"))
                {
                    ...
                    CPurchaseReturn ccr = PurchaseService.ReadPurchaseBill(mTextBoxRefBillNo.Text.Trim(), "PW", CommonMethods.getFinancialCode(mDTPRefDate.SelectedDate.Value));
        ...
        private void saveDataToDatabase()
        {
            ...
            {                
                ...
                using (ChannelFactory<IPurchaseReturn> PurchaseReturnProxy = new ChannelFactory<ServerServiceInterface.IPurchaseReturn>("PurchaseReturnEndpoint"))
                {
                    ...
                    { 
                        success = PurchaseReturnService.UpdateBill(ccp, "PRW");
                    }
                    else
                    {                    
                        success = PurchaseReturnService.CreateBill(ccp, "PRW");
                    }
        ...
        private void deleteDataFromDatabase()
        {
            try
            {
                using (ChannelFactory<IPurchaseReturn> PurchaseReturnProxy = new ChannelFactory<ServerServiceInterface.IPurchaseReturn>("PurchaseReturnEndpoint"))
                {
                    ...
                    bool success= PurchaService.DeleteBill(mTextBoxBillNo.Text.Trim(), "PRW", CommonMethods.getFinancialCode(mDTPDate.SelectedDate.Value));
