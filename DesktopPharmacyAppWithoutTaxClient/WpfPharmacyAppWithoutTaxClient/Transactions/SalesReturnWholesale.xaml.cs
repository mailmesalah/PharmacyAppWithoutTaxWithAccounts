...
namespace WpfClientApp.Transactions
{
    ...
    /// </summary>
    public partial class SalesReturnWholesale : Window
    {
        ...
        public SalesReturnWholesale(string billNo, DateTime billDate)
        {
            InitializeComponent();
            loadInitialDetails();
        ...
        private string getLastBillNo()
        {
            ...
            try {
                using (ChannelFactory<ISalesReturn> SalesReturnProxy = new ChannelFactory<ServerServiceInterface.ISalesReturn>("SalesReturnEndpoint"))
                {
                    ...
                    billNo=SalesService.ReadNextBillNo("SRW",CommonMethods.getFinancialCode(mDTPDate.SelectedDate.Value)).ToString();                    
                }
            }
            catch (Exception e)
            {
        ...
        private void showDataFromDatabase()
        {
            try
            {
                using (ChannelFactory<ISalesReturn> SalesReturnProxy = new ChannelFactory<ServerServiceInterface.ISalesReturn>("SalesReturnEndpoint"))
                {
                    ...
                    CSalesReturn ccr= SalesReturnervice.ReadBill(mTextBoxBillNo.Text.Trim(), "SRW", CommonMethods.getFinancialCode(mDTPDate.SelectedDate.Value));
        ...
        private void showRefBillDataFromDatabase()
        {
            try
            {
                using (ChannelFactory<ISalesReturn> SalesProxy = new ChannelFactory<ServerServiceInterface.ISalesReturn>("SalesReturnEndpoint"))
                {
                    ...
                    CSalesReturn ccr = SalesService.ReadSalesBill(mTextBoxRefBillNo.Text.Trim(), "SW", CommonMethods.getFinancialCode(mDTPRefDate.SelectedDate.Value));
        ...
        private void saveDataToDatabase()
        {
            ...
            {                
                ...
                using (ChannelFactory<ISalesReturn> SalesReturnProxy = new ChannelFactory<ServerServiceInterface.ISalesReturn>("SalesReturnEndpoint"))
                {
                    ...
                    if (mSalesReturnID != "")
                    { 
                        success = SalesReturnService.UpdateBill(ccp, "SRW");
                    }
                    else
                    {                    
                        success = SalesReturnService.CreateBill(ccp, "SRW");
                    }
        ...
        private void deleteDataFromDatabase()
        {
            try
            {
                using (ChannelFactory<ISalesReturn> SalesReturnProxy = new ChannelFactory<ServerServiceInterface.ISalesReturn>("SalesReturnEndpoint"))
                {
                    ...
                    bool success= PurchaService.DeleteBill(mTextBoxBillNo.Text.Trim(), "SRW", CommonMethods.getFinancialCode(mDTPDate.SelectedDate.Value));
