...
{    
    ...
    public interface IBankWithdrawal
    {
        ...
        [OperationContract]
        List<CBankWithdrawalReportSummary> FindBankWithdrawalsSummary(DateTime startDate, DateTime endDate, string billNo, string bankCode, string bank, string ledgerCode, string ledger, string status, string narration, string financialCode);
        [OperationContract]
        List<CBankWithdrawalReportDetailed> FindBankWithdrawalsDetailed(DateTime startDate, DateTime endDate, string billNo, string bankCode, string bank, string ledgerCode, string ledger, string status, string narration, string financialCode);
    ...
    [DataContract]
    public class CBankWithdrawalReportSummary
    {
        string billNo;
        DateTime? billDateTime = new DateTime();
        string financialCode;
    ...
    [DataContract]
    public class CBankWithdrawalReportDetailed
    {
        string billNo;
        DateTime? billDateTime = new DateTime();
        string financialCode;
